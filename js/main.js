        ...
        <div class="container mx-auto px-6 py-4">
                ...
                <div class="hidden md:flex space-x-6 font-bold text-xs items-center tracking-wide font-heading">
                    ...
                    <div class="relative group">
                        ...
                        <div class="absolute left-0 mt-2 w-56 bg-white rounded-xl shadow-xl py-2 hidden group-hover:block border border-emerald-100 z-50">
                            <a href="projects.html" class="block px-4 py-3 text-slate-600 hover:bg-emerald-50 hover:text-emerald-700 font-bold flex items-center gap-2"><i class="fas fa-th-large w-4"></i> All Projects</a>
                            <a href="mangrove.html" class="block px-4 py-3 text-slate-600 hover:bg-emerald-50 hover:text-emerald-700 font-bold border-t border-slate-50 flex items-center gap-2"><i class="fas fa-route w-4"></i> Mangrove Labyrinth</a>
                            <a href="donate.html" class="block px-4 py-3 text-slate-600 hover:bg-emerald-50 hover:text-emerald-700 font-bold border-t border-slate-50 flex items-center gap-2"><i class="fas fa-anchor w-4"></i> Luntian Anchor</a>
                        </div>
                    </div>

                    <a href="status.html" class="nav-link text-emerald-100 hover:text-white transition py-1">STATUS</a>
                    
                    <!-- VIBE LINK -->
                    <a href="music.html" class="nav-link text-emerald-100 hover:text-white transition py-1">VIBE</a>

                    <!-- Login Icon -->
                    <a href="login.html" class="text-emerald-100 hover:text-white transition py-1" title="Member Portal">
                        <i class="fas fa-user-circle text-lg"></i>
                    </a>

                    <a href="donate.html" class="bg-yellow-400 text-[#064e3b] px-4 py-2 rounded-full hover:bg-yellow-300 transition shadow-md font-black">
                        DONATE
                    </a>
                </div>
            ...
            <div id="mobile-menu" class="hidden md:hidden mt-4 pb-4 border-t border-emerald-600/30 pt-4 flex flex-col space-y-4 font-heading">
                ...
                <div class="pl-4 border-l-2 border-emerald-500/30 space-y-2">
                    ...
                    <a href="mangrove.html" class="block text-emerald-100 font-bold hover:text-white">Mangrove Labyrinth</a>
                    <a href="donate.html" class="block text-emerald-100 font-bold hover:text-white">Luntian Anchor</a>
                </div>
                <a href="status.html" class="block text-emerald-100 font-bold hover:text-white">STATUS</a>
                <a href="music.html" class="block text-emerald-100 font-bold hover:text-white">VIBE</a>
                <a href="social.html" class="block text-emerald-100 font-bold hover:text-white">SOCIAL FEED</a>
                <a href="login.html" class="block text-emerald-100 font-bold hover:text-white border-t border-emerald-600/30 pt-2">MEMBER LOGIN</a>
            </div>
        </div>
    </nav>`;
        ...
        <div class="container mx-auto px-6 grid md:grid-cols-4 gap-8 text-sm">
            <div class="col-span-1 md:col-span-2">
                ...
                <div class="flex space-x-4 mt-6">
                    <a href="social.html" class="text-slate-400 hover:text-white transition"><i class="fas fa-globe-asia fa-lg"></i></a>
            ...
            <div>
                ...
                <ul class="space-y-2 font-sans">
                    <li><a href="about.html" class="hover:text-emerald-400 transition">About Us</a></li>
                    <li><a href="activities.html" class="hover:text-emerald-400 transition">Activities</a></li>
                    <li><a href="mangrove.html" class="hover:text-emerald-400 transition">Mangrove Campaign</a></li>
                    <li><a href="music.html" class="hover:text-emerald-400 transition">Luntian Vibe</a></li>
                </ul>
            </div>
            <div>
